...
|---|---|---:|---:|---|
| 1 | Document Classifier | 1.0000 | 100.00% | Within target |
| 2 | Eligibility Models (tier/match/alignment) | 1.0000 | 100.00% | Within target |
| 3 | Recommendation Ranker | 1.0000 | 100.00% | Within target |
| 4 | Phase2 Anomaly Detector | 0.9344 | 93.44% | Within target |
| 5 | Phase4 Scheduler | 0.6800 | 68.00% | Below target |

## Professional Summary

- Document Classifier achieved 100.00% using 900 training samples and 45 testing or validation samples.
- Eligibility Models (tier/match/alignment) achieved 100.00% using 32 training samples and 8 testing or validation samples.
- Recommendation Ranker achieved 100.00% using 32 training samples and 8 testing or validation samples.
